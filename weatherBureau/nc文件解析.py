        ...
        for var_name, variable in dataset.variables.items():
            ...
            if isinstance(raw_data, np.ndarray):
                if raw_data.dtype.kind == "S":
                    data = [
                        s.decode("utf-8", errors="ignore") for s in raw_data.flatten()
                    ]
...
if __name__ == "__main__":
    try:
        ...
        nc_file = current_dir / "wrfprs_d01.2025070703.f14.nc"
        json_file = current_dir / "wrfprs_d01.2025070703.f14.json"
